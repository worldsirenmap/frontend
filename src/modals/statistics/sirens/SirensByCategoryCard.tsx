...
export default () => {
    ...
    const [{data, loading}] = useAxios<SirenCountByXList>("statistics/sirencountbycategory")

    return (
        <Box px={20} mb={40}>
            <Title px={10} pb={10} order={3}>{t("$ui.modals.statistics.sirens.bycategory.title")}</Title>
